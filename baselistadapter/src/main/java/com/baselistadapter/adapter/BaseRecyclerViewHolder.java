...
public class BaseRecyclerViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return
     */
    public static BaseViewHolder getViewHolder(View convertView, ViewGroup parent, int layoutId) {
        BaseViewHolder mHolder;
        if (null == convertView) {
            mHolder = new BaseViewHolder(parent, layoutId);
        } else {
     ...
     */
//    public BaseRecyclerViewHolder setImageUrl(@IdRes int viewId, @NonNull String url) {
//        ImageView view = getView(viewId);
//        Picasso.with(mRootView.getContext()).load(url).resize(100, 100).centerCrop().into(view);
//        return this;
//    }
     ...
     * @return The BaseRecyclerViewHolder for chaining.
     */
    public BaseRecyclerViewHolder setOnClickListener(@IdRes int viewId, View.OnClickListener listener) {
        View view = getView(viewId);
     ...
     * @return The BaseRecyclerViewHolder for chaining.
     */
    public BaseRecyclerViewHolder setOnTouchListener(@IdRes int viewId, View.OnTouchListener listener) {
        View view = getView(viewId);
     ...
     */
    @Deprecated
    public BaseRecyclerViewHolder setOnLongClickListener(@IdRes int viewId, View.OnLongClickListener listener) {
        View view = getView(viewId);
     ...
     */
    @Deprecated
    public BaseRecyclerViewHolder setOnItemClickListener(@IdRes int viewId, AdapterView.OnItemClickListener listener) {
