...
/**
 * 对viewholder进行封装设计，以便于在开发的过程中，无特殊
...
public class  BaseViewHolder {
    ...
    public BaseViewHolder(ViewGroup parent, int layoutId) {
        this.mRootView = View.inflate(parent.getContext(), layoutId, null);
     ...
     * @return The BaseViewHolder for chaining.
     */
//    public BaseViewHolder setImageUrl(@IdRes int viewId, @NonNull String url) {
//        ImageView view = getView(viewId);
